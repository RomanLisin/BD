...
DECLARE @year INT = 2025; -- Можно изменить на нужный год
DECLARE @easter DATE;
...
---- Пасха и 2 дополнительных дня (Пасхальный понедельник и вторник)
--INSERT INTO Holidays VALUES 
--    (@easter, N'Пасха'),
--    (DATEADD(DAY, 1, @easter), N'Пасхальный понедельник'),
--    (DATEADD(DAY, 2, @easter), N'Пасхальный вторник');

--PRINT 'Таблица Holidays успешно заполнена!';
