...
BEGIN
    ...
    BEGIN
        ...
        SET @numberLessons_disc1 = @numberLessons_disc1 - 1;
		INSERT INTO Schedule ([group], discipline, teacher, [date], [time], spent)
        VALUES (@group, @discipline_1, @teacher, @date, DATEADD(MINUTE,190,@time), IIF(@date < GETDATE(), 1, 0));
        SET @numberLessons_disc1 = @numberLessons_disc1 - 1;
    END
    ...
    BEGIN
        ...
        SET @numberLessons_disc2 = @numberLessons_disc2 - 1;
		 INSERT INTO Schedule ([group], discipline, teacher, [date], [time], spent)
        VALUES (@group, @discipline_2, @teacher, @date, DATEADD(MINUTE,190,@time), IIF(@date < GETDATE(), 1, 0));
        SET @numberLessons_disc2 = @numberLessons_disc2 - 1;
    END
